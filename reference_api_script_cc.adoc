...
summary: 以下のスクリプトを使用すると、スクリプト内で定義されたパラメータとJSON入力ファイルに基づいてクラスタを作成できます。 
---
= ONTAP Select クラスタを作成するスクリプト
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
以下のスクリプトを使用すると、スクリプト内で定義されたパラメータとJSON入力ファイルに基づいてクラスタを作成できます。
